...
npm run dev
```
then modify index.js to play around the various score combinations.
...
npm test
```
To run all tests with coverage (100%)
```bash
npm run cover
```
...
We are hosting a tennis tournament. To aid with this, a scoring system is being developed.
